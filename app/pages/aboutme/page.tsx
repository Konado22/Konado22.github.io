    ...
    return (
        ...
        <div>
            ...
            <div className="p-10 text-pretty text-2xl indent-4">
                ...
                <p className='p-10 text-pretty text-2xl indent-4'>I cannot wait to dive into the field further. For any business or project inqueries please reach out to me through Github or Gmail.</p>
                <p>Below is a code review conducted on original artifacts from my Program and enhacements to be made to these assignments <br/></p>
